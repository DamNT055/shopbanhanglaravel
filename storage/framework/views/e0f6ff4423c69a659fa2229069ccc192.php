    ...
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            <form action="<?php echo e(URL::to('/admin-dashboard')); ?>" method="post">
                ...
                <span><input type="checkbox" /> Nhớ đăng ký</span>
...
<?php /**PATH D:\XAMPP_HTDOC\htdocs\Laravel\Website bán hàng Youtube\shopbanhanglaravel\resources\views/admin_login.blade.php ENDPATH**/ ?>